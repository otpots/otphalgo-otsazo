					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 010 2356
										3513</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>
										song3513@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-9">
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">여성의류<i
										class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										<li><a href="#"
											onclick="location.href='티셔츠'; return false;">티셔츠</a></li>
								...
								<li class="dropdown"><a href="#">남성의류<i
										class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										<li><a href="#">티셔츠</a></li>
										<li><a href="#">니트·가디건</a></li>
								...
								<li class="dropdown"><a href="#">캐주얼의류<i
										class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										<li><a href="#">티셔츠</a></li>
										<li><a href="#">셔츠·남방</a></li>
								...
								<li class="dropdown"><a href="#">스포츠의류<i
										class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
